...
var incompleteTaskHolder=document.querySelector(".list-incompleted");//ul of #incompleted
var completedTasksHolder=document.querySelector(".list-completed");//completed
